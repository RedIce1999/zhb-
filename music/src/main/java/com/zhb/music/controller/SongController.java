...
import com.zhb.music.service.impl.SongServiceImpl;
...
//    更新歌曲图片
    ...
    public Object updateSongPic(@RequestParam("file") MultipartFile urlFile, @RequestParam("id")int id){
        ...
        System.out.println(System.getProperty("user.dir")+"+++"+System.getProperty("file.separator")+"+++"+System.getProperty("file.separator"));
        File file1 = new File(filePath);
        if (!file1.exists()){
            file1.mkdir();
        }
